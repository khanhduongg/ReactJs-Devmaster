        ...
        <div className="wrapper-box box-about">
          ...
          <div className="row about-vision">
            <div className="col-md-12">
              <h4>tầm nhìn</h4>
              <img src="../img/tamnhin.jpg" alt="" className="w-100" />
              <p>
          ...
          <div className="row about-policy">
            <div className="col-md-6">
              <div className="thumbnail">
                <img
                  src="../img/su-menh1.jpg"
                  alt=""
                  className="image"
                />
                <div className="content">
                  <p className="title">Với xã hội</p>
                  <p className="desc">
                    Hài hòa lới ích doanh nghiệp với lợi ích xã hội, tích cực
            ...
            <div className="col-md-6">
              <div className="thumbnail">
                <img
                  src="../img/su-menh2.jpg"
                  alt=""
                  className="image"
                />
                <div className="content">
                  <p className="title">Với nhân viên</p>
                  <p className="desc">
            ...
            <div className="col-md-6">
              <div className="thumbnail">
                <img
                  src="../img/su-menh3.jpg"
                  alt=""
                  className="image"
                />
                <div className="content">
                  <p className="title">Với đối tác</p>
                  <p className="desc">
                    Đề cao tinh thần hợp tác cùng phát triển, cam kết trở thành
                    "người đồng hành số 1" của đối tác.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-6">
              <div className="thumbnail">
                <img
                  src="../img/su-menh4.jpg"
                  alt=""
                  className="image"
                />
                <div className="content">
                  <p className="title">Với thị trường</p>
                  <p className="desc">
                    Đề cao tinh thần hợp tác cùng phát triển, cam kết trở thành
                    "người đồng hành số 1" của đối tác.
                  </p>
...
export default CaterageIntroduce;
